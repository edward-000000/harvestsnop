...
function (
        ...
        "buttons": [
            {
                ...
                customize: function ( win ) {
                    $(win.document.body)
                        ...
                        .prepend(
                            '<div class="dt-print-heading"><img class="logo" src='+baseUrl+'"/assets/harvestsnop/img/logo-favicons/1_logo.png"/><h2 class="title">'+window.store.name+'</h2><p><b><i>From</i> '+window.from +' <i>To</i> '+window.to+'</b><br>Printed on: '+window.formatDate(new Date())+'</p></div>'
    ...
    $(document).delegate("#reset", "click", function (e) {
        ...
        $("#to_store_id").val("").trigger("change");
        $("#image_thumb img").attr("src", "../assets/harvestsnop/img/noimage.jpg");
        $("#image").val("");
