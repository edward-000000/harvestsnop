...
function (
    ...
    $(document).delegate("#create-product-submit", "click", function(e) {
        ...
        then(function(response) {
            ...
            setTimeout(function() {
                ...
                $("#p_thumb img").attr("src", "../assets/harvestsnop/img/noimage.jpg");
                $("#p_image").val("");
            }, 100);
    ...
    $(document).delegate(".purchase-product", "click", function (e) {
        ...
        window.location = window.baseUrl+"/administrador/purchase.php?box_state=open&p_code="+$scope.product.p_code+"&sup_id="+$scope.product.sup_id;
    });
