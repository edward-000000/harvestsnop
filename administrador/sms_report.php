...
// Add Script
$document->addScript('../assets/harvestsnop/angular/modals/SMSResendModal.js');
$document->addScript('../assets/harvestsnop/angular/controllers/SMSReportController.js');
