...
// Add Script
$document->addScript('../assets/harvestsnop/angular/modals/SellLogViewModal.js');
$document->addScript('../assets/harvestsnop/angular/controllers/SellLogController.js');
