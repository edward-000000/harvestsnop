...
if (user_group_id() != 1 && !has_permission('access', 'read_transfer')) {
  redirect(store('base_url') . '/administrador/dashboard.php');
}
...
// Add Script
$document->addScript('../assets/harvestsnop/angular/modals/TransferDetailsViewModal.js');
$document->addScript('../assets/harvestsnop/angular/modals/TransferEditModal.js');
$document->addScript('../assets/harvestsnop/angular/controllers/TransferController.js');
