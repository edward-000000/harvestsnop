...
// Add Script
$document->addScript('../assets/harvestsnop/angular/modals/PurchaseLogViewModal.js');
$document->addScript('../assets/harvestsnop/angular/controllers/PurchaseLogController.js');
