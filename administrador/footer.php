    ...
    <footer class="main-footer">
    	...
    	<div class="copyright">Copyright © <?php echo date('Y '); ?> <a href="https://harvestsnop.senati.es/">Harverstsnop</a>, Todos los derechos reservados. Elaborado por Edward y Abrahan</div>
    </footer>
</div>
<!-- End Wrapper -->
