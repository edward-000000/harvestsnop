...
// Add Script
$document->addScript('../assets/harvestsnop/angular/modals/SellReturnViewModal.js');
$document->addScript('../assets/harvestsnop/angular/controllers/SellReturnController.js');
