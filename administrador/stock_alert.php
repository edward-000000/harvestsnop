...
// Add Script
// $document->addScript('../assets/harvestsnop/angular/modals/PurchaseProductModal.js');
$document->addScript('../assets/harvestsnop/angular/controllers/StockAlertController.js');
