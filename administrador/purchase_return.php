...
// Add Script
$document->addScript('../assets/harvestsnop/angular/modals/PurchaseReturnViewModal.js');
$document->addScript('../assets/harvestsnop/angular/controllers/PurchaseReturnController.js');
