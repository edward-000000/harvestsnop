...
// Add Script
$document->addScript('../assets/harvestsnop/angular/controllers/ReportLossController.js');
$document->addScript('../assets/harvestsnop/angular/controllers/ReportProfitController.js');
