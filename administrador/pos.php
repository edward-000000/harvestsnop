...
<head>
	...
	<?php else : ?>
		...
		<!-- Filemanager CSS -->
	    <link href="../assets/harvestsnop/css/filemanager/dialogs.css" type="text/css" rel="stylesheet">
	    <link href="../assets/harvestsnop/css/filemanager/main.css" type="text/css" rel="stylesheet">

	    <!-- Theme CSS -->
	    <link href="../assets/harvestsnop/css/theme.css" type="text/css" rel="stylesheet">

	    <!-- Skin Black CSS -->
	    <link href="../assets/harvestsnop/css/skins/skin-black.css" type="text/css" rel="stylesheet">

	    <!-- Skin Blue CSS -->
	    <link href="../assets/harvestsnop/css/skins/skin-blue.css" type="text/css" rel="stylesheet">

	    <!-- Skin Green CSS -->
	    <link href="../assets/harvestsnop/css/skins/skin-green.css" type="text/css" rel="stylesheet">

	    <!-- Skin Red CSS -->
	    <link href="../assets/harvestsnop/css/skins/skin-red.css" type="text/css" rel="stylesheet">

	    <!-- Skin Yellow CSS -->
	    <link href="../assets/harvestsnop/css/skins/skin-yellow.css" type="text/css" rel="stylesheet">

	    <!-- Main CSS -->
	    <link href="../assets/harvestsnop/css/main.css" type="text/css" rel="stylesheet">

		<!-- Skeleton CSS -->
		<link href="../assets/harvestsnop/css/pos/skeleton.css" rel="stylesheet" type="text/css">

		<!-- Main CSS -->
		<link href="../assets/harvestsnop/css/pos/pos.css" rel="stylesheet" type="text/css">

		<!-- Responsive CSS -->
		<link href="../assets/harvestsnop/css/pos/responsive.css" rel="stylesheet" type="text/css">
	...
	<style type="text/css">
		body::after { 
			content: ""; background: url(../assets/harvestsnop/img/pos/patterns/<?php echo $user->getPreference('pos_pattern') ? $user->getPreference('pos_pattern') : 'armysuit.jpg'; ?>) repeat repeat;opacity: 0.4;filter: alpha(opacity=40);top: 0;left: 0;bottom: 0;right: 0;position: absolute;z-index: -1;
		}
...
<?php include('../_inc/template/pos_skeleton.php'); ?>
						...
						<div class="contents">
							...
							<div id="item-list">
								...
								<div ng-show="showLoader" class="ajax-loader">
									<img src="../assets/harvestsnop/img/loading2.gif">
								</div>
	...
	<?php if (DEMO || USECOMPILEDASSET) : ?>
		...
		<script src="../assets/harvestsnop/jsmin/pos.js" type="text/javascript"></script>
	...
	<?php else : ?>
		...
		<!-- POS Main JS -->
		<script src="../assets/harvestsnop/js/pos/pos.js" type="text/javascript"></script>

<?php endif; ?>

<script src="../assets/harvestsnop/angular/modals/AddInvoiceNoteModal.js" type="text/javascript"></script>
<script src="../assets/harvestsnop/angular/modals/AddCustomerMobileNumberModal.js" type="text/javascript"></script>
<script src="../assets/harvestsnop/angular/modals/HoldingOrderModal.js" type="text/javascript"></script>
<script src="../assets/harvestsnop/angular/modals/HoldingOrderDetailsModal.js" type="text/javascript"></script>
<script src="../assets/harvestsnop/angular/controllers/PosController.js" type="text/javascript"></script>
<noscript>
