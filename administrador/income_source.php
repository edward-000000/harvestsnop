...
// Add Script
$document->addScript('../assets/harvestsnop/angular/modals/IncomeSourceEditModal.js');
$document->addScript('../assets/harvestsnop/angular/modals/IncomeSourceDeleteModal.js');
$document->addScript('../assets/harvestsnop/angular/controllers/IncomeSourceController.js');
