...
if (isset($action) && $action == 'reset')  
{
	if (!empty($stores))
	{
		...
		if (!is_cli()) {
			redirect(root_url() . '/administrador/reset.php?action=done');
		}
	} else {
...
<?php if (isset($request->get['action']) && $request->get['action'] == 'done'):?>
	...
	<div class="container">
		...
		<div class="buttons">
			<a class="btn back" href="<?php echo root_url();?>/administrador/dashboard.php">&larr;Back to Dashboard</a>
		</div>
	</div>
	</div>
<?php else:?>
<form action="<?php echo root_url();?>/administrador/reset.php?action=reset" method="POST">
	<div id="reset-form">
	<div class="container">
		<div class="container-inner">
			<?php if (!empty($errors)):?>
		...
		<div class="buttons">
			...
			<a class="btn no" href="<?php echo root_url();?>/administrador/dashboard.php">NO</a>
		</div>
	</div>
	</div>
</form>
