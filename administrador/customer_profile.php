...
// Add ScriptS
$document->addScript('../assets/harvestsnop/angular/modals/InstallmentPaymentModal.js');
$document->addScript('../assets/harvestsnop/angular/modals/InstallmentViewModal.js');
$document->addScript('../assets/harvestsnop/angular/modals/CustomerSubstractBalanceModal.js');
$document->addScript('../assets/harvestsnop/angular/modals/CustomerAddBalanceModal.js');
$document->addScript('../assets/harvestsnop/angular/controllers/CustomerController.js');
$document->addScript('../assets/harvestsnop/angular/controllers/CustomerProfileController.js');
