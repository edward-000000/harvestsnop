...
// Add Script
$document->addScript('../assets/harvestsnop/angular/modals/LanguageCreateModal.js');
$document->addScript('../assets/harvestsnop/angular/modals/LanguageEditModal.js');
$document->addScript('../assets/harvestsnop/angular/controllers/LanguageController.js');
