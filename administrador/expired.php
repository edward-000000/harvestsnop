...
// Add Script
$document->addScript('../assets/harvestsnop/angular/modals/ProductEditModal.js');
$document->addScript('../assets/harvestsnop/angular/controllers/ExpiredProductController.js');
