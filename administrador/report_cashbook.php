...
// Add Script
$document->addScript('../assets/harvestsnop/angular/controllers/ReportIncomeDaywiseController.js');
$document->addScript('../assets/harvestsnop/angular/controllers/ReportExpenseDaywiseController.js');
