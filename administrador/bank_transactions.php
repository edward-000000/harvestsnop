...
// Add Script
$document->addScript('../assets/harvestsnop/angular/controllers/BankingController.js');
          ...
          <div class="box-header">
            ...
            <div class="btn-group pull-right">
              ...
              <ul class="dropdown-menu" role="menu">
                <li>
                  <a href="<?php echo root_url();?>/administrador/bank_transactions.php">
                    <?php echo trans('text_view_all_transactions'); ?>
                  </a>
                </li>
                <?php foreach (get_bank_accounts() as $account) : ?>
                  <li>
                    <a href="<?php echo root_url();?>/administrador/bank_transactions.php?account_id=<?php echo $account['id'];?>">
