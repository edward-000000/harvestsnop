...
// Add ScriptS
$document->addScript('../assets/harvestsnop/angular/controllers/UserController.js');
$document->addScript('../assets/harvestsnop/angular/controllers/UserProfileController.js');
$document->addScript('../assets/harvestsnop/angular/controllers/ReportUserSellController.js');
$document->addScript('../assets/harvestsnop/angular/controllers/UserLoginLogController.js');
