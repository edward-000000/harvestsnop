...
// Add Style
$document->addStyle('../assets/harvestsnop/css/barcode.css', 'stylesheet', 'all');

// Add Script
$document->addScript('../assets/harvestsnop/angular/controllers/BarcodePrintController.js');
          ...
          <div class='box-body'> 
            ...
            <div id="barcode-con">
              ...
              if(isset($request->post['products'])):
                ...
                if (!$per_page) {
                  redirect(root_url() . '/administrador/barcode_print.php');
                }
                $page_layout = '';
                switch ($per_page) {
                  case '10':
                ...
                ?>
                  ...
                  <div class="text-center">
                    <div class="btn-group">
                      <button class="btn btn-warning" onClick="window.printContent('barcode-con', {title:'<?php echo trans('text_barcode_print');?>',screenSize:'fullScreen', cssLink:'<link type=\'text/css\' href=\'../assets/harvestsnop/css/barcode.css\' type=\'text/css\' rel=\'stylesheet\'>'});"><span class="fa fa-print"></span> <?php echo trans('button_print');?></button>
                    </div>
                  </div>
                        ...
                        <div class="item-inner">
                          <?php if (isset($request->post['fields']['product_image']) && $request->post['fields']['product_image']):?>
                            <span class="product_image">
                              ...
                              <?php else : ?>
                                <img src="../assets/harvestsnop/img/noimage.jpg">
                              <?php endif; ?>
                            </span>
                          <?php endif;?>
                          <?php if (isset($request->post['fields']['site_name']) && $request->post['fields']['site_name']):?>
