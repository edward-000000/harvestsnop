...
// Add Script
$document->addScript('../assets/harvestsnop/angular/controllers/ReportIncomeController.js');
$document->addScript('../assets/harvestsnop/angular/controllers/ReportExpenseController.js');
