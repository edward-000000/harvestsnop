...
$document->setTitle(trans('title_analitica'));
                                    ...
                                    <div class="nav-tabs-custom mb-0">
                                        <ul class="nav nav-tabs">
                                            <li class="active">
                                                ...
                                                <?php // *** Se ha eliminado la pestaña comentada "birthday_coming" *** ?>
                                            </li>
                                        </ul>
                                        <div class="tab-content" style="height:215px;overflow-y:scroll;">
                                            ...
                                            <?php // *** Se ha eliminado el contenido comentado de la pestaña "birthday_coming" *** ?>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                        ...
                                        <table class="table table-bordered table-striped table-condensed">
                                            ...
                                            foreach ($logs as $log):?>
                                                <tr>
                                                    ...
                                                    <td class="text-center"><?php echo $log['status'] == 'success' ? '<label class="label label-success">'.trans('label_logged_in').'</label>' : '<label class="label label-danger">'.trans('label_failed').'</label>';?></td>
                                                </tr>
                                            <?php endforeach;?>
                                            </tbody>
                                        </table>
